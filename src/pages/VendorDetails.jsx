...
// const VendorDetails = () => {
//   const { vendorId } = useParams(); // Retrieve vendorId from URL
...
//         // Create a map of product_id to component_id for quick lookup
//         const componentMap = data.reduce((acc, component) => {
//           acc[component.product_id] = component.component_id || "null"; // "null" if component_id does not exist
//           return acc;
//         }, {});
...
//   }, [vendorId, setSelectedVendorData]);

//   // Function to get component_id based on product_id
//   const getComponentId = (product_id) => {
//     return componentMasterData[product_id] || "null"; // "null" if component_id does not exist
//   };
...
//     img: null,
//     attachments: null,
//     vendor: selectedVendorData[0]?.vendor || "",
//   });
...
//       ...newProduct, // Spread user-input values
//       vendor: vendorId,
//     };
...
//     navigate("/vendor"); // Navigate back to the Vendors list page
//   };

//   //
//   //
//   //
//   // The return furnction

//   return (
//     <div>
//       <h4>Vendor Data for {newProduct.vendor}</h4>
