...
//     const updatedRows = [...newRows];
//     updatedRows[popupIndex].qty = quantity;
//     setNewRows(updatedRows);
...
//     .filter((row) => row.checked && row.serial_number)
//     .map((row) => {
//       const item = availableRequests.find(
//         (item) => item.serial_number === row.serial_number
//       );
//       return {
//         ...item,
...
//             />
//             <br />
//             <button onClick={confirmQuantity} style={{ padding: "5px 10px", marginRight: "10px" }}>Confirm</button>
//             <button onClick={() => setPopupVisible(false)} style={{ padding: "5px 10px" }}>Cancel</button>
//           </div>
//         </div>
//       )}
